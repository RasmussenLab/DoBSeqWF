process VEP {
    ...
    path alphamissense // optional AlphaMissense file
    path clinvar // optional ClinVar VCF
    path danmac // optional DanMac VCF
    path blacklist // optional blacklist BED
    path repeatmasks // optional repeat masks BED
    path gnomad // optional gnomAD VCF
    ...
    def loft = loftee_gerp_bigwig && loftee_human_ancestor && loftee_conservation ? "--plugin LoF,loftee_path:/plugins,gerp_bigwig:${loftee_gerp_bigwig},human_ancestor_fa:${loftee_human_ancestor},conservation_file:${loftee_conservation}" : ""
    """
    vep \
        --assembly GRCh38 \
        --format vcf \
